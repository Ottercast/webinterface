...
class ComposerAutoloaderInit5c61ebb25fbeda7d2e3c2d4ff8f67256
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit5c61ebb25fbeda7d2e3c2d4ff8f67256::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire5c61ebb25fbeda7d2e3c2d4ff8f67256($fileIdentifier, $file);
        }
...
function composerRequire5c61ebb25fbeda7d2e3c2d4ff8f67256($fileIdentifier, $file)
{
